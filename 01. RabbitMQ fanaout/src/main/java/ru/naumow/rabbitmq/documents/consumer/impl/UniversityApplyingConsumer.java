...
public class UniversityApplyingConsumer extends AbstractConsumer {

    @Override
    protected String getFilename() {
        return "university_applying.pdf";
    }
    ...
    protected void handle(Document document, Map<String, String> userInfo) throws DocumentException {
        ...
        Chunk chunk = new Chunk("University declaration\n", font);
        document.add(chunk);
        document.add(Chunk.NEWLINE);

        font = FontFactory.getFont(FontFactory.TIMES_ROMAN, 16, Font.BOLD, BaseColor.BLACK);
